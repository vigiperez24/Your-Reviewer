...
function Sidebar() {
  ...
  const menuItems = [
    ...
    { id: "progress", label: "Progress", icon: <FaChartBar />, path: "/progress" },
  ...
  return (
    <div className={`h-screen flex-shrink-0 transition-all duration-300 ${isOpen ? "w-72" : "w-20"} bg-white shadow`}>
      ...
      <div className="flex items-center justify-between px-5 py-4">
        ...
        >
          <FaChevronLeft className={`text-gray-500 transition-transform duration-300 ${!isOpen && "rotate-180"}`} />
        </button>
      </div>
