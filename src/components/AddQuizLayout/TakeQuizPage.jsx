...
function TakeQuizPage() {
  ...
  let current = quizzes[currentQuestionIndex];
      ...
      <div className="max-w-md md:max-w-2xl space-y-4">
          ...
          {!getStarted && (
            <div className="flex flex-col gap-4 p-4 shadow-md">
              ...
              <div className=" text-xl text-center text-gray-500">
                <p>
                  You will have {quizzes.length} questions. Answer them one by one. Best of
                  Luck!
                </p>
              </div>
        ...
        {getStarted && (
          <div className="flex items-center justify-between ">
            ...
            <button
              onClick={handleNext}
              className="bg-buttonBg text-white gray-300 md:text-xl text-base p-2 rounded"
            >
              Next
            </button>
          </div>
